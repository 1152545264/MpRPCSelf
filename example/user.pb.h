...
class LoginResponse PROTOBUF_FINAL :
 ...
 public:
  ...
  void clear_sunccess();
  bool sunccess() const;
  void set_sunccess(bool value);
  private:
  bool _internal_sunccess() const;
  void _internal_set_sunccess(bool value);
  public:
...
// bool sunccess = 2;
inline void LoginResponse::clear_sunccess() {
  sunccess_ = false;
}
inline bool LoginResponse::_internal_sunccess() const {
  return sunccess_;
}
inline bool LoginResponse::sunccess() const {
  // @@protoc_insertion_point(field_get:fixbug.LoginResponse.sunccess)
  return _internal_sunccess();
}
inline void LoginResponse::_internal_set_sunccess(bool value) {
  
  sunccess_ = value;
}
inline void LoginResponse::set_sunccess(bool value) {
  _internal_set_sunccess(value);
  // @@protoc_insertion_point(field_set:fixbug.LoginResponse.sunccess)
}
