...
class GetFriendListRequestResponseDefaultTypeInternal {
 public:
  ::PROTOBUF_NAMESPACE_ID::internal::ExplicitlyConstructed<GetFriendListRequestResponse> _instance;
...
static void InitDefaultsscc_info_GetFriendListRequestResponse_test_2eproto() {
  GOOGLE_PROTOBUF_VERIFY_VERSION;

  {
    void* ptr = &::fixbug::_GetFriendListRequestResponse_default_instance_;
    new (ptr) ::fixbug::GetFriendListRequestResponse();
    ::PROTOBUF_NAMESPACE_ID::internal::OnShutdownDestroyMessage(ptr);
  }
  ::fixbug::GetFriendListRequestResponse::InitAsDefaultInstance();
}

::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<2> scc_info_GetFriendListRequestResponse_test_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 2, 0, InitDefaultsscc_info_GetFriendListRequestResponse_test_2eproto}, {
...
const ::PROTOBUF_NAMESPACE_ID::uint32 TableStruct_test_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  ~0u,  // no _has_bits_
  PROTOBUF_FIELD_OFFSET(::fixbug::GetFriendListRequestResponse, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  PROTOBUF_FIELD_OFFSET(::fixbug::GetFriendListRequestResponse, result_),
  PROTOBUF_FIELD_OFFSET(::fixbug::GetFriendListRequestResponse, friendlist_),
};
static const ::PROTOBUF_NAMESPACE_ID::internal::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  { 35, -1, sizeof(::fixbug::GetFriendListRequestResponse)},
};
...
static ::PROTOBUF_NAMESPACE_ID::Message const * const file_default_instances[] = {
  ...
  reinterpret_cast<const ::PROTOBUF_NAMESPACE_ID::Message*>(&::fixbug::_GetFriendListRequestResponse_default_instance_),
};
...
const char descriptor_table_protodef_test_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  "er.Sex\"\031\n\003Sex\022\007\n\003MAN\020\000\022\t\n\005WOMAN\020\001\"d\n\034Get"
  "FriendListRequestResponse\022\"\n\006result\030\001 \001("
  "\0132\022.fixbug.ResultCode\022 \n\nfriendList\030\002 \003("
  "\0132\014.fixbug.User2\234\001\n\016UserServiceRpc\0224\n\005Lo"
  "gin\022\024.fixbug.LoginRequest\032\025.fixbug.Login"
  "Response\022T\n\016GetFriendLists\022\034.fixbug.GetF"
  "riendListRequest\032$.fixbug.GetFriendListR"
  "equestResponseB\003\200\001\001b\006proto3"
  ;
...
static ::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase*const descriptor_table_test_2eproto_sccs[6] = {
  ...
  &scc_info_GetFriendListRequestResponse_test_2eproto.base,
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_test_2eproto = {
  false, false, descriptor_table_protodef_test_2eproto, "test.proto", 587,
...
void GetFriendListRequestResponse::InitAsDefaultInstance() {
  ::fixbug::_GetFriendListRequestResponse_default_instance_._instance.get_mutable()->result_ = const_cast< ::fixbug::ResultCode*>(
      ::fixbug::ResultCode::internal_default_instance());
}
class GetFriendListRequestResponse::_Internal {
 public:
  static const ::fixbug::ResultCode& result(const GetFriendListRequestResponse* msg);
};

const ::fixbug::ResultCode&
GetFriendListRequestResponse::_Internal::result(const GetFriendListRequestResponse* msg) {
  return *msg->result_;
}
GetFriendListRequestResponse::GetFriendListRequestResponse(::PROTOBUF_NAMESPACE_ID::Arena* arena)
  : ::PROTOBUF_NAMESPACE_ID::Message(arena),
  friendlist_(arena) {
  SharedCtor();
  RegisterArenaDtor(arena);
  // @@protoc_insertion_point(arena_constructor:fixbug.GetFriendListRequestResponse)
}
GetFriendListRequestResponse::GetFriendListRequestResponse(const GetFriendListRequestResponse& from)
  : ::PROTOBUF_NAMESPACE_ID::Message(),
  ...
  // @@protoc_insertion_point(copy_constructor:fixbug.GetFriendListRequestResponse)
}

void GetFriendListRequestResponse::SharedCtor() {
  ::PROTOBUF_NAMESPACE_ID::internal::InitSCC(&scc_info_GetFriendListRequestResponse_test_2eproto.base);
  result_ = nullptr;
}

GetFriendListRequestResponse::~GetFriendListRequestResponse() {
  // @@protoc_insertion_point(destructor:fixbug.GetFriendListRequestResponse)
  SharedDtor();
  _internal_metadata_.Delete<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>();
}

void GetFriendListRequestResponse::SharedDtor() {
  GOOGLE_DCHECK(GetArena() == nullptr);
  if (this != internal_default_instance()) delete result_;
}

void GetFriendListRequestResponse::ArenaDtor(void* object) {
  GetFriendListRequestResponse* _this = reinterpret_cast< GetFriendListRequestResponse* >(object);
  (void)_this;
}
void GetFriendListRequestResponse::RegisterArenaDtor(::PROTOBUF_NAMESPACE_ID::Arena*) {
}
void GetFriendListRequestResponse::SetCachedSize(int size) const {
  _cached_size_.Set(size);
}
const GetFriendListRequestResponse& GetFriendListRequestResponse::default_instance() {
  ::PROTOBUF_NAMESPACE_ID::internal::InitSCC(&::scc_info_GetFriendListRequestResponse_test_2eproto.base);
  return *internal_default_instance();
}


void GetFriendListRequestResponse::Clear() {
// @@protoc_insertion_point(message_clear_start:fixbug.GetFriendListRequestResponse)
  ::PROTOBUF_NAMESPACE_ID::uint32 cached_has_bits = 0;
  // Prevent compiler warnings about cached_has_bits being unused
  (void) cached_has_bits;
...
const char* GetFriendListRequestResponse::_InternalParse(const char* ptr, ::PROTOBUF_NAMESPACE_ID::internal::ParseContext* ctx) {
#define CHK_(x) if (PROTOBUF_PREDICT_FALSE(!(x))) goto failure
  ::PROTOBUF_NAMESPACE_ID::Arena* arena = GetArena(); (void)arena;
  while (!ctx->Done(&ptr)) {
    ::PROTOBUF_NAMESPACE_ID::uint32 tag;
...
::PROTOBUF_NAMESPACE_ID::uint8* GetFriendListRequestResponse::_InternalSerialize(
    ::PROTOBUF_NAMESPACE_ID::uint8* target, ::PROTOBUF_NAMESPACE_ID::io::EpsCopyOutputStream* stream) const {
  // @@protoc_insertion_point(serialize_to_array_start:fixbug.GetFriendListRequestResponse)
  ::PROTOBUF_NAMESPACE_ID::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  // @@protoc_insertion_point(serialize_to_array_end:fixbug.GetFriendListRequestResponse)
  return target;
}

size_t GetFriendListRequestResponse::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:fixbug.GetFriendListRequestResponse)
  size_t total_size = 0;
...
void GetFriendListRequestResponse::MergeFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) {
// @@protoc_insertion_point(generalized_merge_from_start:fixbug.GetFriendListRequestResponse)
  GOOGLE_DCHECK_NE(&from, this);
  const GetFriendListRequestResponse* source =
      ::PROTOBUF_NAMESPACE_ID::DynamicCastToGenerated<GetFriendListRequestResponse>(
          &from);
  if (source == nullptr) {
  // @@protoc_insertion_point(generalized_merge_from_cast_fail:fixbug.GetFriendListRequestResponse)
    ::PROTOBUF_NAMESPACE_ID::internal::ReflectionOps::Merge(from, this);
  } else {
  // @@protoc_insertion_point(generalized_merge_from_cast_success:fixbug.GetFriendListRequestResponse)
    MergeFrom(*source);
  }
}

void GetFriendListRequestResponse::MergeFrom(const GetFriendListRequestResponse& from) {
// @@protoc_insertion_point(class_specific_merge_from_start:fixbug.GetFriendListRequestResponse)
  GOOGLE_DCHECK_NE(&from, this);
  _internal_metadata_.MergeFrom<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>(from._internal_metadata_);
  ::PROTOBUF_NAMESPACE_ID::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
...
void GetFriendListRequestResponse::CopyFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) {
// @@protoc_insertion_point(generalized_copy_from_start:fixbug.GetFriendListRequestResponse)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}

void GetFriendListRequestResponse::CopyFrom(const GetFriendListRequestResponse& from) {
// @@protoc_insertion_point(class_specific_copy_from_start:fixbug.GetFriendListRequestResponse)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}

bool GetFriendListRequestResponse::IsInitialized() const {
  return true;
}

void GetFriendListRequestResponse::InternalSwap(GetFriendListRequestResponse* other) {
  using std::swap;
  _internal_metadata_.Swap<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>(&other->_internal_metadata_);
...
::PROTOBUF_NAMESPACE_ID::Metadata GetFriendListRequestResponse::GetMetadata() const {
  return GetMetadataStatic();
}
...
void UserServiceRpc::GetFriendLists(::PROTOBUF_NAMESPACE_ID::RpcController* controller,
                         ...
                         ::fixbug::GetFriendListRequestResponse*,
                         ::google::protobuf::Closure* done) {
    ...
    case 1:
      GetFriendLists(controller,
             ::PROTOBUF_NAMESPACE_ID::internal::DownCast<const ::fixbug::GetFriendListRequest*>(
                 request),
             ::PROTOBUF_NAMESPACE_ID::internal::DownCast<::fixbug::GetFriendListRequestResponse*>(
                 response),
             done);
      break;
    default:
...
const ::PROTOBUF_NAMESPACE_ID::Message& UserServiceRpc::GetResponsePrototype(
  ...
  switch(method->index()) {
    ...
    case 1:
      return ::fixbug::GetFriendListRequestResponse::default_instance();
    default:
      GOOGLE_LOG(FATAL) << "Bad method index; this should never happen.";
      return *::PROTOBUF_NAMESPACE_ID::MessageFactory::generated_factory()
...
template<> PROTOBUF_NOINLINE ::fixbug::GetFriendListRequestResponse* Arena::CreateMaybeMessage< ::fixbug::GetFriendListRequestResponse >(Arena* arena) {
  return Arena::CreateMessageInternal< ::fixbug::GetFriendListRequestResponse >(arena);
}
