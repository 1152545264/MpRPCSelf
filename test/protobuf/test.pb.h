...
class GetFriendListRequestResponse PROTOBUF_FINAL :
 ...
 public:
  ...
  virtual ~GetFriendListRequestResponse();
  ...
  inline GetFriendListRequestResponse* New() const final {
    return CreateMaybeMessage<GetFriendListRequestResponse>(nullptr);
  }

  GetFriendListRequestResponse* New(::PROTOBUF_NAMESPACE_ID::Arena* arena) const final {
...
// repeated .fixbug.User friendList = 2;
inline int GetFriendListRequestResponse::_internal_friendlist_size() const {
  return friendlist_.size();
}
inline int GetFriendListRequestResponse::friendlist_size() const {
  return _internal_friendlist_size();
}
inline void GetFriendListRequestResponse::clear_friendlist() {
  friendlist_.Clear();
}
inline ::fixbug::User* GetFriendListRequestResponse::mutable_friendlist(int index) {
  // @@protoc_insertion_point(field_mutable:fixbug.GetFriendListRequestResponse.friendList)
  return friendlist_.Mutable(index);
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::fixbug::User >*
GetFriendListRequestResponse::mutable_friendlist() {
  // @@protoc_insertion_point(field_mutable_list:fixbug.GetFriendListRequestResponse.friendList)
  return &friendlist_;
}
inline const ::fixbug::User& GetFriendListRequestResponse::_internal_friendlist(int index) const {
  return friendlist_.Get(index);
}
inline const ::fixbug::User& GetFriendListRequestResponse::friendlist(int index) const {
  // @@protoc_insertion_point(field_get:fixbug.GetFriendListRequestResponse.friendList)
  return _internal_friendlist(index);
}
inline ::fixbug::User* GetFriendListRequestResponse::_internal_add_friendlist() {
  return friendlist_.Add();
}
inline ::fixbug::User* GetFriendListRequestResponse::add_friendlist() {
  // @@protoc_insertion_point(field_add:fixbug.GetFriendListRequestResponse.friendList)
  return _internal_add_friendlist();
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::fixbug::User >&
GetFriendListRequestResponse::friendlist() const {
  // @@protoc_insertion_point(field_list:fixbug.GetFriendListRequestResponse.friendList)
  return friendlist_;
}
